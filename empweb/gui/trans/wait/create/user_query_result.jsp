      ...
      <table id="result">
        ...
        <jxp:forEach
          ...
          <tr>
            ...
            <td>
            <c:if test="${param.record_id!='undefined'}">
               <a href="indexw.jsp?user_id=${ptr['u:id']}&amp;user_db=${ptr['ancestor::qr:databaseResult/@name']}&amp;record_id=${fn:trim(param.record_id)}&amp;volume_id=${fn:trim(param.volume_id)}">                            
            </c:if>            
            <c:if test="${param.record_id=='undefined'}">
              <a href="indexw.jsp?user_id=${ptr['u:id']}&amp;user_db=${ptr['ancestor::qr:databaseResult/@name']}">
            </c:if>
                 ${ptr["u:id"]}
              </a>
