        ...
        <jxp:forEach
          ...
          <c:forEach items="${volsMap}" var="vol">
            ...
            <tr>
              ...
              <td>
                <a href="record_status_result.jsp?record_id=${ptr["mod:recordInfo/mod:recordIdentifier"]}&amp;object_db=${ptr['ancestor::qr:databaseResult/@name']}&amp;volume_id=${vol.value}">${ptr["mod:recordInfo/mod:recordIdentifier"]}</a>
              </td>
              <td>
                <a href="record_status_result.jsp?record_id=${ptr["mod:recordInfo/mod:recordIdentifier"]}&amp;object_db=${ptr['ancestor::qr:databaseResult/@name']}&amp;volume_id=${vol.value}">${vol.value}</a>
              </td>                  
                ...
                <c:choose>
                  ...
                  <c:when test="${(not empty param.show_all_copies or copiesCount lt 2)}">
                    ...
                    <jxp:forEach  cnode="${ptr}" var="ptr2" select="${forEachVol}" nsmap="${nsm}">
                      ...
                      <a href="copy_status_result.jsp?copy_id=${ptr2['hol:copyId']}&amp;object_db=${ptr['ancestor::qr:databaseResult/@name']}">
                        ${ptr2["hol:copyId"]}
                      </a>
                      <br/>
                    </jxp:forEach>                    
