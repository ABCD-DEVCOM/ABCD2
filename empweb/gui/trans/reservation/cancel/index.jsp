...
<div class="middle homepage">
  <h1><fmt:message key="cancel_reservation"/></h1>
  <h2><fmt:message key="cancel_reservation_form"/></h2>
  ...
  <c:choose>
    ...
    <c:otherwise>
      ...
      <form method="get" action="cancel_reservation_result.jsp">
        ...
        <table>
          <tr>
            ...
            <td>
              <input type="text" name="reservation_id"
                <c:if test="${not empty fn:trim(param.reservation_id) }">
                  value="${param.reservation_id}"
                </c:if>
              </input>
              <c:if test="${empty param.reservation_id and not empty param.submit}"> <fmt:message key="required_field"/></c:if>
            </td>
          </tr>
          ...
          <tr>
            <td></td>
            <td><input type="submit" name="submit" value="<fmt:message key="cancel_reservation"/>"/></td>
          </tr>
        </table>
      </form>
