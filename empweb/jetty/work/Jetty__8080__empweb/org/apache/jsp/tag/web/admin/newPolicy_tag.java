...
public final class newPolicy_tag
  ...
  private boolean _jspx_meth_io_body_0(javax.servlet.jsp.tagext.JspTag _jspx_th_io_soap_0, PageContext _jspx_page_context)
    ...
    if (_jspx_eval_io_body_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      ...
      do {
        ...
        out.write("        <newPolicy xmlns=\"http://kalio.net/empweb/engine/admin/v1\">\r\n");
        out.write("          <name>");
        out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${fn:trim(name)}", java.lang.String.class, (PageContext)this.getJspContext(), _jspx_fnmap_0, false));
        out.write("</name>\r\n");
        out.write("        </newPolicy>\r\n");
        out.write("      </soapenv:Body>\r\n");
