...
class ISISItem implements OAIItem {
    ...
    # object constructor
//    function ISISItem($myDBArray, $ItemId, $datestamp = NULL, $SearchInfo = NULL)
    function __construct($ItemId, $datestamp = NULL, $SearchInfo = NULL)
    {
    ...
    function __ISISItem($ItemId, $datestamp = NULL, $SearchInfo = NULL) {
        self:: __construct($ItemId, $datestamp = NULL, $SearchInfo = NULL);
    }
