...
var ChartsAmcharts = function() {
    ...
    var initChartSample5 = function() {
        var chart = AmCharts.makeChart("chart_5", {
            ...
            "color":    '#888',
			<?php
				$color = Array('FF0F00','FF6600','FF9E01','FCD202','F8FF01','B0DE09','04D215','0D8ECF','0D52D1','2A0CD0','8A0CCF','CD0D74','754DEB','DDDDDD','999999','333333','000000','FF0F00','FF6600','FF9E01','FCD202','F8FF01','B0DE09','04D215','0D8ECF','0D52D1','2A0CD0','8A0CCF','CD0D74','754DEB','DDDDDD','999999','333333','000000');
				$now = time();
				$last30 = $now - (3600 *24*30);
				$x = 0;
				echo '"dataProvider": [';
				for($s = $last30; $s<=$now; $s+=(3600*24)){
					$next = $s + (3600 * 24);
					$q = $U->select('user_statements','amount',"WHERE user='$user' AND trans_type LIKE '%Sell%' AND created_on>='$s' AND created_on<'$next'",null,null);
					$day_sum = 0;
					while($r = $U->fetchArray($q)){
						$amount = $r['amount'];
						$currency = 'USD';
						$p = $U->convertPrice($currency,$amount);
	...
	var initChartSample62 = function() {
        var chart = AmCharts.makeChart("pie_chart_1", {
            "type": "pie",
            "theme": "light",
			...
			echo '{
						"title": "My Books",
						"views": '.$U->publishedBooksByUser($user).'
				},{
						"title": "Books I\'ve read",
						"views": '.$U->booksReadByUser($user).'
				},{
						"title": "Books I\'ve bought",
						"views": '.$U->booksDownloadedByUser($user).'
				}';
			echo '],';
			?>
            "valueField": "views",
            ...
            "exportConfig": {
                menuItems: [{
                    icon: Metronic.getGlobalPluginsPath() + "amcharts/amcharts/images/export3.png",
                    format: 'png'
                }]
            }
        });
    }
	var initChartSample61 = function() {
        var chart = AmCharts.makeChart("pie_chart", {
            ...
            "exportConfig": {
                menuItems: [{
                    icon: Metronic.getGlobalPluginsPath() + "amcharts/amcharts/images/export1.png",
                    format: 'png'
                }]
            }
        });
    ...
    var initChartSample6 = function() {
        var chart = AmCharts.makeChart("pie_chart_31", {
            "type": "pie",
            "theme": "light",
	...
	var initChartSample63 = function() {
        var chart = AmCharts.makeChart("pie_chart_33", {
            "type": "pie",
            "theme": "light",
            ...
            "exportConfig": {
                menuItems: [{
                    icon: Metronic.getGlobalPluginsPath() + "amcharts/amcharts/images/export2.png",
                    format: 'png'
                }]
            }
        });
    ...
    var initChartSample7 = function() {
        var chart = AmCharts.makeChart("pie_chart_32", {
            "type": "pie",
            "theme": "light",
