...
class soap_server extends nusoap_base {
    ...
    */
    function webDescription(){
		$b = '
		<html><head><title>'.$this->wsdl->serviceName.'</title>
		<style type="text/css">
			...
			background-color: #999999; width: 90%; margin-left: 0px;
			padding-top: 10px; padding-bottom: 10px; padding-left: 15px;}
		    .hidden {
			position: absolute; visibility: hidden; z-index: 200; left: 295px; top: 110px;
			font-family: arial; overflow: hidden; width: 600;
			padding: 20px; font-size: 10px; background-color: #999999;
			layer-background-color:#FFFFFF; }
			a 		    { color: #930009; font-weight: bold; text-decoration: none; border-bottom: 1px dashed #CCC;}
			a:hover     { text-decoration: none; border-bottom: 1px dashed #930009;}
