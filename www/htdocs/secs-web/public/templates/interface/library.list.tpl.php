...
var lblLibFullname  = "{$BVS_LANG.lblLibFullname}";
var lblAddress  = "{$BVS_LANG.lblAddress}";
var lblCity  = "{$BVS_LANG.lblCity}";
...
var lblLibrary  = "{$BVS_LANG.lblLibrary}";
...
var btEdLibrary = "{$BVS_LANG.btEdLibrary}";
...
<div class="helpBG" id="formRow01_helpA" style="display: none;">
    <div class="helpArea">
            ...
            <h2>{$BVS_LANG.help} - {$BVS_LANG.field} {$BVS_LANG.lblSearchLibrary}</h2>
            <div class="help_message">
                {$BVS_LANG.helpSearchLibrary}
            </div>
    </div>
</div>
