...
<html>
    <head>
        ...
        <script>
        function Guardar(){        	 document.forms[0].action="../barcode_save.php"
...
if (file_exists($db_path.$base."/def/".$_SESSION["lang"]."/barcode_code.tab")){
	$fp=file($db_path.$base."/def/".$_SESSION["lang"]."/barcode_code.tab",true);
	foreach ($fp as $value){		$parm=explode('=',$value);
		$default_value[$parm[0]]=trim($parm[1]);	}
}
$default_value['text'] = '';
    ...
    <div class="configurations">
        <section class="configurations">
            ...
            <table>
                ...
                <tbody>
                	<tr>
                	   	<td><label for="type">Symbology</label></td>
            			<td><?php echo getSelectHtml('type', $filename, $availableBarcodes); ?>
            				<a class="info explanation" href="#"><img src="info.gif" alt="Explanation" /></a></td>
            		</tr>
                    <tr>
...
?>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="generate" style="float: left"><?php echo getInputTextHtml('text', $text, array('type' => 'text', 'required' => 'required')); ?> <input type="submit" value="Generate" />
                            <input type=button value=Guardar onclick=javascript:Guardar()></div>
