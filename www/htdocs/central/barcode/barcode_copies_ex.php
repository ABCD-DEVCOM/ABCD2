...
global $xWxis,$msgstr,$db_path,$Wxis,$wxisUrl,$lang_db;
 	...
 	$query = "&base=$base&cipar=$db_path"."par/".$cipar. "&from=" . $from."&to=$to&Pft=(v90/)";
 	echo $query;
...
global $db_path,$lang_db,$xWxis,$Wxis,$wxisUrl,$fe_classification;
	$base=$base;
	$cipar=$base.".par";
...
global $db_path,$lang_db,$xWxis,$wxisUrl,$Wxis;
	$base=$base;
	$cipar=$base.".par";
	$IsisScript= $xWxis."ifp.xis";
	$ver="";
...
function MfnBarCode($base,$from,$to,$classification_number_format,$copies,$pref_control,$output){
...
switch ($arrHttp["Opcion"]){	case "mfn":
		MfnBarCode($arrHttp["base"],$arrHttp["mfn_from"],$arrHttp["mfn_to"],$classification_number_format,$copies,$pref_control,$arrHttp["output"]);
		break;
	case "clasificacion":
    ...
    case "control":
    	...
    	break;
    case "inventario":
    	//InventarioBarCode($arrHttp["base"],$arrHttp["inventory_from"],$arrHttp["inventory_to"],$inventory_number_format,$copies,$inventory_number_pref,$arrHttp["output"]);
		break;
	case "date":
