...
if (!isset($_REQUEST["Opcion"]) or $_REQUEST["Opcion"]!="Guardar"){
    ...
    echo "</textarea>" ;
    echo "<p>";
    echo "<div><img src=../../../opac/images/arrow.jpg style=\"margin-top:-7px;vertical-align: middle;\"> &nbsp;<input type=submit name=guardar value=\" ".$msgstr["save"]." opac_conf/dc_sch.xml \" onclick=document.marcxml.submit() style=\"font-size:15px;\"></div>";
	echo "</form>";
	echo "</div>";
}
