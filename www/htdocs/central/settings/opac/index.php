		...
		if (substr($value,0,7)=="include" and $config_php==""){
			if ($config_php==""){
				...
				if (!file_exists($config_php)){
					...
					echo "Please check the <strong>include</strong> path in <strong><font color=black>$dir/config_opac.php</font></strong> ";
...
<html lang="es" xmlns="http://www.w3.org/1999/xhtml" xml:lang="es">
	<head>
		...
		<!-- Stylesheets -->
		<link rel="stylesheet" rev="stylesheet" href=../../../opac/styles/styles.css type="text/css" media="screen"/>
		<!--[if IE]>
...
<body style="background:white">
	<div >
		<div>
			<h1><img src=../../../opac/images/circulos.png></a>
...
<?php
	if (file_exists("../../../opac/php/opac_dbpath.dat")){
		echo "<tr><td>";
		$fp=file("../../../opac/php/opac_dbpath.dat");
