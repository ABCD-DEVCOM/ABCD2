...
//Geththe path of the collection folder
$truepathcol=$db_path.$base_ant."/collections/";
$drpathtext=$fp=file($db_path.$base_ant."/dr_path.def");
foreach($fp as $avalue)
{
...
//echo 'truepathcol=' . $truepathcol . '<p>';
    ...
    <td width="71" align="left" style="font-size:14px"><input type="text" name="publisher" size="2" value="v5"/></td>
     ...
     <td width="71" align="left" style="font-size:14px"><input type="text" name="url" size="2" value="v98"/></td>
	  ...
	  <tr>
	    ...
	    <td align="left" style="font-size:14px"><input type="text" name="doctext" size="2" value=""/></td>	    
...
echo 'tikacommand='.$tikacommand.'<br>';
...
//Windows
$tikacommand='java -jar '.$tikapath.'tika.jar -h '.$truepathcol.$fixpath.$newdocname.$total.".".$ext.' >'.$db_path."wrk/".$newdocname.$total.'.html';
// new $tikacommand='java -jar '.$tikapath.'tika.jar -h -i'.$truepathcol.$fixpath. ' -o '.$db_path."wrk/";
//echo '<br>Tikacmd='. $tikacommand.'<br>';
//die;
exec($tikacommand,$outcm,$banderacm);
}
...
//echo '<BR> docsourcepath before ='.$docsourcepath;
if (strpos($OS,"WIN")=== false) {} else {$docsourcepath=str_ireplace('/','\\',$docsourcepath);}
//echo '<BR> docsourcepath after ='.$docsourcepath;
//die;
if (($fixpath!="") and ($fixpath!="ABCDImportRepo/")) $vspath=substr($fixpath,0,-1);
//if (($currentID!="") and ($vid!="")) $fieldspart.="<".$vid.">".$currentID."<&#47;".$vid.">";
if (($currentID!="") and ($vid!="")) $fieldspart.="'a".$vid."~".$currentID."~', ";
//if (($title!="") and ($vtitle!="")) $fieldspart.="<".$vtitle.">".$title."<&#47;".$vtitle.">";
if (($title!="") and ($vtitle!="")) $fieldspart.="'a".$vtitle."~".$title."~', ";
//if (($creator!="") and ($vcreator!="")) $fieldspart.="<".$vcreator.">".$creator."<&#47;".$vcreator.">";
if (($creator!="") and ($vcreator!="")) $fieldspart.="'a".$vcreator."~".$creator."~', ";
//if (($subject!="") and ($vsubject!="")) $fieldspart.="<".$vsubject.">".$subject."<&#47;".$vsubject.">";
if (($subject!="") and ($vsubject!="")) $fieldspart.="'a".$vsubject."~".$subject."~', ";
//if (($description!="") and ($vdescription!="")) $fieldspart.="<".$vdescription.">".$description."<&#47;".$vdescription.">";
if (($description!="") and ($vdescription!="")) $fieldspart.="'a".$vdescription."~".$description."~', ";
//if (($publisher!="") and ($vpublisher!="")) $fieldspart.="<".$vpublisher.">".$publisher."<&#47;".$vpublisher.">";
if (($publisher!="") and ($vpublisher!="")) $fieldspart.="'a".$vpublisher."~".$publisher."~', ";
//if (($created!="") and ($vdate!="")) $fieldspart.="<".$vdate.">".$created."<&#47;".$vdate.">";
if (($created!="") and ($vdate!="")) $fieldspart.="'a".$vdate."~".$created."~', ";
//if (($ext!="") and ($vtype!="")) $fieldspart.="<".$vtype.">".$ext."<&#47;".$vtype.">";
if (($ext!="") and ($vtype!="")) $fieldspart.="'a".$vtype."~".$ext."~', ";
//if (($format!="") and ($vformat!="")) $fieldspart.="<".$vformat.">".$format."<&#47;".$vformat.">";
if (($format!="") and ($vformat!="")) $fieldspart.="'a".$vformat."~".$format."~', ";
//if (($archivo!="") and ($vsource!="")) $fieldspart.="<".$vsource.">".$archivo."<&#47;".$vsource.">";
if (($archivo!="") and ($vsource!="")) $fieldspart.="'a".$vsource."~".$archivo."~', ";
//if ($vsections!="") $fieldspart.="<".$vsections.">".$vspath."<&#47;".$vsections.">"; 
if ($vsections!="") $fieldspart.="'a".$vsections."~".$vspath."~', "; 
//if (($fixpath.$newdocname.$total.".".$ext!="") and ($vurl!="")) $fieldspart.="<".$vurl.">".$fixpath.$newdocname.$total.".".$ext."<&#47;".$vurl.">"; 
if (($fixpath.$newdocname.$total.".".$ext!="") and ($vurl!="")) $fieldspart.="'a".$vurl."~".$fixpath.$newdocname.$total.".".$ext."~', "; 
//$fieldspart.="<112>".$procstartedatN."<&#47;112>";
$fieldspart.="'a112~".$procstartedatN."~', ";
//if (($vdocsource!="") and ($vurl!="")) $fieldspart.="<".$vdocsource.">".$docsourcepath."<&#47;".$vdocsource.">"; 
if (($vdocsource!="") and ($vurl!="")) $fieldspart.="'a".$vdocsource."~".$docsourcepath."~', "; 
//$fieldspart.="'\"";
$fieldspart.="\"";
//echo '<br>fieldspart='.$fieldspart.'<br>';
//die;
...
//Save the text into a file but also in field
...
//echo '<br>!gloadproc='.$mx . '<br>';
exec($mx,$outmx,$banderamx);
}
else
{
//Save the text into a file only
...
$mxinv="";
if ($vdoctext!="") $mxinv=$converter_path." ".$db_path.$base_ant."/data/".$base_ant." fst=@".$db_path.$base_ant."/data/".$base_ant.".fst fullinv/m=".$db_path.$base_ant."/data/".$base_ant." now -all";
else $mxinv=$converter_path." ".$db_path.$base_ant."/data/".$base_ant." fst=@".$db_path.$base_ant."/data/fulltext.fst fullinv/m=".$db_path.$base_ant."/data/".$base_ant." now -all";
//echo 'mxinv='.$mxinv.'<p>';
echo 'Indexing database, please wait...<p>'; 
...
{
echo '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp<label style="font-weight:bold;color:red">Fatal Error</label></br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbspThe ABCDImportRepo folder  '. $truepathcol . 'does not exist or is write protected';	
}//end else if (is_dir($img_path.$base_ant."/collection/ABCDImportRepo/"))
}//end if (is_dir($img_path.$base_ant."/collection/"))
else
{
echo '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp<label style="font-weight:bold;color:red">Fatal Error</label></br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbspThe collection folder ' . $truepathcol . 'does not exist or is write protected';	
}//end else if (is_dir($img_path.$base_ant."/collection/ABCDImportRepo/"))
