 ...
 * @file:      barcode_configure_ex.php
 * @desc:      Guarda la configuración para emitir la etiqueta del código de barras
...
echo "<font color=white>&nbsp; &nbsp; Script: barcode_font/barcode_configure_ex.php";
?>
</font>
</div>
...
$fp=fopen($db_path.$base."/def/".$_SESSION["lang"]."/barcode_label.tab","w");
foreach ($_REQUEST as $var=>$value){	if ($var!="base"){		echo "$var=$value<br>";
		fwrite($fp,$var."=".$value."\n");
	}
}
fclose($fp);
echo "<h4>barcode_label.tab Guardado!!";
?>
