...
?>
	...
	<br>
	<div class="col-6">
		<label><?php echo $msgstr["cents"];?></label>
		<input type="text" size="10" name="decimals" value="<?php if (isset($locales["decimals"])) echo $locales["decimals"];?>">
	</div>
	<br>
	<div class="col-6">
		<label><?php echo $msgstr["thousand"];?></label>
		<input type="text" size="10" name="thousand" value="<?php if (isset($locales["thousand"])) echo $locales["thousand"];?>">
	</div>
	<br>
	<div class="col-6">
		<label><?php echo $msgstr["fine"];?></label>
		<input type="text" size="10" name="fine" value="<?php if (isset($locales["fine"])) echo $locales["fine"];?>">
	</div>
	<br>
	<div class="col-6">
