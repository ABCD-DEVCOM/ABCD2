...
// se presenta la  informacion del usuario
	...
	$fecha_exp=$fecha_dia;
	if (count($susp)>0 and $AC_SUSP=="Y"){          // se determina el vencimiento de la �ltima sanci�n
...
//se determina la fecha de la pr�xima suspensi�n en base al vencimiento de la �ltima suspensi�n
	echo "<script>\n";
