    	...
    	for (i=0;i<item.length;i++){
            ...
            if (Trim(sel)!="" && sel!="undefined"){
		    	...
		    	for (var c in cell){
		    		...
		    		switch (c){
		    			case "0":
		    				html+="<td colspan=2 width='300'>"
		    				html+="<a  class='bt bt-green bt-sm bt-block' href=javascript:Editar_Tabla("+i+")>"+TI[cell[c]]+" ("+cell[c]+")"
		    				break
		    			case "1":
		    				html+="<br> x <br>"+TU[cell[c]]+" ("+cell[c]+")</a></td>\n"
		    				break
		    			case "2":
		    			case "3":
		    			case "4":
			...
			html+="<td><a class='button_browse delete' href=javascript:Eliminar("+i+")>"
