...
global $db_path,$Wxis,$xWxis,$wxisUrl,$lang_db,$msgstr,$actparfolder;
...
//	echo $control_number;
	...
	$query = "&Opcion=disponibilidad&base=$db&cipar=$db_path".$actparfolder."$db.par&Expresion=".$Expresion."&Pft=$pft_cn";
...
global $db_path,$Wxis,$xWxis,$wxisUrl,$lang_db,$pft_in,$msgstr,$config_date_format,$lista_control_no,$actparfolder;
    $inventarios_show="";
	...
	$query = "&Opcion=disponibilidad&base=$db&cipar=$db_path".$actparfolder."/$db.par&Expresion=".$Expresion."&Formato=$formato_obj";
	include("../common/wxis_llamar.php");
	$total=0;
	$titulo="";
	foreach ($contenido as $linea){
