		    	...
		    	for (var c in cell){
		    		...
		    		switch (c){
		    			case "0":
		    				html+="<td width='150'>"
		    				html+="<div>"
		    				html+="<a class='button_browse edit'  href=javascript:Agregar("+i+")>"
		    				html+="<i class='fas fa-plus' alt='<?php echo $msgstr["crear"];?>' title='<?php echo $msgstr["crear"];?>'></i>"
		    				html+="<a class='button_browse delete' href=javascript:Eliminar("+i+")>"
		    				html+="<i class='far fa-trash-alt' alt='<?php echo $msgstr["delete"];?>' title='<?php echo $msgstr["delete"];?>'></i>"
		    				html+="</a>"
		    				html+="</div>"
		    				html+="<a style='float: left; display: block; margin-top: 8px;' class='button_browse show' href=javascript:Editar_Tabla("+i+")>"+TI[cell[c]]+" ("+cell[c]+")</a>"
		    				html+="</td>\n"
		    				break
		    			case "1":
