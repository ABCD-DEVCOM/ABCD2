...
<?php
// se lee el formato de la fecha utilizando la configuraci�n de pr�stamos
...
foreach ($exp as $value){
	...
	if ($value!=""){
		$e=explode('_',$value);
		$Mfn[$value]=$value;  // se hace un arreglo que tiene el MFN y el n�mero de la ocurrencia
		$value="MFN_".$e[0];  // se construye la expresi�n de b�squeda
		if ($Expresion==""){
			$Expresion=$value;
		}else{
			$Expresion.=" or $value";
