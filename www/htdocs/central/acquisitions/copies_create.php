<?php
//
// Crea en la base de datos copias los �tems procedentes de una orden de compra
...
// se lee la FDT para conseguir la etiqueta del campo donde se coloca la numeraci�n autom�tica
...
// Se verifica si esa orden de compra-recomendaci�n-cotizaci�n ya ha sido actrualizada
...
// ya se carg� esa orden de compra - recomendacion-cotizaci�n en la base de datos
