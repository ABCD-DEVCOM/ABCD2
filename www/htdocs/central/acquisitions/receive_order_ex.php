...
$closed=trim($linea[4]);
$l=explode('^^',$linea[1]);
// se obtiene la informaci�n correspondiente a los objetos ya actualizados para evitar la duplicaci�n  (campo 500 de purchaseorder)
print $linea[0];
if ($closed!=""){
