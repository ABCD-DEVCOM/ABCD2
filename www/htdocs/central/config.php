...
2023-06-01 fho4abcd Improve charset in header statement
2024-06-01 fho4abcd Add captcha
*/
...
if (stripos($_SERVER["SERVER_SOFTWARE"],"Win") > 0) {
        // Windows variables
	$ABCD_path="/xampp/htdocs/ABCD2/";             // base path to ABCD-installation
 	$db_path="/xampp/htdocs/ABCD2/www/bases-examples_windows/";     // path where the databases are to be located
...
if ((isset($def["CAPTCHA"])) && ($def["CAPTCHA"]=="N")) {
	$setcaptcha="N"; 
	$def["CAPTCHA"]=$setcaptcha;	
} else {
	$setcaptcha="Y"; 
	$def["CAPTCHA"]=$setcaptcha;
}
