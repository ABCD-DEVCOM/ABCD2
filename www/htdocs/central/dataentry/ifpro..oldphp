...
/* Pasar los términos seleccionados */
			...
			<?php
				...
				window.opener.document.forma1.busqueda_palabras.value=TerminosSeleccionados.substr(Prefijo.length)
    ...
    <tr>
      ...
      <td rowspan="2" xwidth="585" valign=top>
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td xwidth=250>
              <select name=terminos  size=16 multiple xwidth=250 <?php if (isset($arrHttp["toolbar"])) echo 'onclick="EjecutarBusqueda(0,2)"'?>)>
              <OPTION VALUE="">
