	...
	<tr>
		<td>
            ...
            <?php if ($_SESSION["profile"]=="adm"){ ?>
				<li><a href='javascript:Ejecutar("../dbadmin/editar_abcd_def.php","abcd_def")'>
                    <?php echo "abcd.def. ".$msgstr["logo_css"];?></a></li>
				<li><a href='Javascript:Ejecutar("../dbadmin/databases_list.php","")'>
                    <?php echo $msgstr["dblist"];?></a></li>
				<li><a href='Javascript:Ejecutar("../dbadmin/editar_correo_ini.php","")'>correo.ini</a></li>
			<?php } ?>
            </ul>
			</form>
		</td>
