...
if($CISIS_VERSION!="")
echo "CISIS_VERSION: ".$CISIS_VERSION;
else echo "CISIS_VERSION: DEFAULT";
//end 
if(isset($m))
{
	if($CISIS_VERSION!="")
$strINV=$cisis_path.$CISIS_VERSION."/mx  ".$bd."/data/".$base. "$cipar fst=@".$bd."/data/".$fst." uctab=$uctab actab=$actab $stw fullinv/m=".$bd."/data/".$base." -all now tell=100";
else $strINV=$cisis_path."mx  ".$bd."/data/".$base. "$cipar fst=@".$bd."/data/".$fst." uctab=$uctab actab=$actab $stw fullinv/m=".$bd."/data/".$base." -all now tell=100";
}
else
{
	if($CISIS_VERSION!="")
$strINV=$cisis_path.$CISIS_VERSION."/mx  ".$bd."/data/".$base. "$cipar fst=@".$bd."/data/".$fst." uctab=$uctab actab=$actab $stw fullinv=".$bd."/data/".$base." -all now tell=100";
