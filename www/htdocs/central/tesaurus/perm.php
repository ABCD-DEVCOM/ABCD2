...
<form method=post name=Lista onSubmit="javascript:return false">
	<table width=100%>
		<td width=50%><img src=../dataentry/img/toolbarSearch.png> <a href=index.php?base=<?php echo $arrHttp["base"]?>><strong><font color=white>Alphabetical</strong></font></a>  &nbsp; &nbsp; <a href=perm.php?perm=Y&base=<?php echo $arrHttp["base"]?>><strong><font color=white>Permuted</strong></font></a></td>
...
?>
	...
	<br><img src=../dataentry/img/toolbarSearch.png><a href=index.php?base=<?php echo $arrHttp["base"]?>><strong>Alphabetical</a>  &nbsp; &nbsp; <a href=perm.php?perm=Y&base=<?php echo $arrHttp["base"]?>>Permuted</a></strong><br>
