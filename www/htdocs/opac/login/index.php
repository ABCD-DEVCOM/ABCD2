...
include($path_levels."central/config.php");
include($path_levels.$app_path."/common/get_post.php");
$new_window=time();
...
include ($path_levels.$app_path."/lang/admin.php");
include ($path_levels.$app_path."/lang/lang.php");	
?>
<!DOCTYPE html>
...
<script src=/<?php echo $path_levels.$app_path?>/dataentry/js/lr_trim.js></script>
...
<?php
include ($path_levels.$app_path."/common/css_settings.php");
?>
</head>
<body>
...
if (isset($arrHttp["login"]) and $arrHttp["login"]=="N"){
		echo "
			<input type=\"text\" autocomplete='username' name=\"login\" id=\"user\" value=\"\" class=\"textEntry superTextEntry inputAlert\" onfocus=\"this.className = 'textEntry superTextEntry inputAlert textEntryFocus';\" onblur=\"this.className = 'textEntry superTextEntry inputAlert';\" />\n";
}else{
		echo "
			<input type=\"text\" autocomplete='username' name=\"login\" id=\"user\" value=\"\" class=\"textEntry superTextEntry\" onfocus=\"this.className = 'textEntry superTextEntry textEntryFocus';\" onblur=\"this.className = 'textEntry superTextEntry';\" />\n";
}
...
?>
		...
		<div class="formRow">
			...
			<input type="password" name="password" autocomplete="current-password" id="pwd" value="" class="textEntry superTextEntry" onfocus="this.className = 'textEntry superTextEntry textEntryFocus';" onblur="this.className = 'textEntry superTextEntry';" />
...
<?php include ($path_levels.$app_path."/common/footer.php");?>
