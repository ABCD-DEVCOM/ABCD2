...
?>
		<h6 class="text-dark"><?php echo $msgstr["front_ecta"]?></h6>
        ...
        <div class="row g-3">
            ...
            <div class="col-md-8">
                <input class="form-control type="text" name="usuario" id="search-user" value="" placeholder=" <?php echo $msgstr["front_user_id"]?>" />
            </div>
            
            <div class="col-md-4">
		        <input class="btn btn-success" type="submit" id="search-user-submit" value="<?php echo $msgstr["front_send"]?>" border=0 />
            </div>
        </div>
