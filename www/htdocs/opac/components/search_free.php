...
if (!isset($mostrar_libre) or $mostrar_libre != "N") {
	...
	<div id="search">
		<form method="get" action="buscar_integrada.php" name="libre">
			...
			if (isset($_REQUEST["base"])) echo "<input id=base type=hidden name=base value=" . $_REQUEST["base"] . ">\n";
			...
			<div class="row g-3">
				...
				<div class="col-md-6">
					<input class="form-control" type="text" name="Sub_Expresion" id="termo-busca" id="search-text" value="<?php if (isset($_REQUEST['Sub_Expresion'])) echo htmlentities($_REQUEST['Sub_Expresion']); ?>" placeholder="<?php echo $msgstr["front_search"] ?>  ..." />
				</div>
				<div class="col-md-3">
