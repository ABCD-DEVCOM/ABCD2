...
include($_SERVER['DOCUMENT_ROOT']."/".$opac_path."/inc/leer_bases.php");
include($_SERVER['DOCUMENT_ROOT']."/".$opac_path."/functions.php");
...
//include $_SERVER['DOCUMENT_ROOT']."/".$opac_path."/functions.php";
include ($_SERVER['DOCUMENT_ROOT'] . "/".$opac_path."/inc/get_ip_address.php");
...
<head>
	...
	<link href="/<?php echo $opac_path;?>/assets/css/bootstrap.min.css" rel="stylesheet">
	<link href="/<?php echo $opac_path;?>/assets/css/bootstrap-icons.css" rel="stylesheet">
	...
	<link href="/<?php echo $opac_path;?>/assets/css/dashboard.css?<?php echo time(); ?>" rel="stylesheet" type="text/css" media="screen" />
	<script src=/<?php echo $opac_path;?>/assets/js/script_b.js?<?php echo time(); ?>></script>
	<script src=/<?php echo $opac_path;?>/assets/js/highlight.js?<?php echo time(); ?>></script>
	<script src=/<?php echo $opac_path;?>/assets/js/lr_trim.js></script>
	<script src=/<?php echo $opac_path;?>/assets/js/selectbox.js></script>
...
<header class="navbar navbar-dark  bg-primary flex-md-nowrap p-0 shadow text-bg-light">
  ...
  <?php include_once $_SERVER['DOCUMENT_ROOT'] . '/'.$opac_path.'/components/topbar.php'; ?>
...
include $_SERVER['DOCUMENT_ROOT'] . '/'.$opac_path.'/components/search_free.php';
} elseif ($_REQUEST["action"]=="advanced") {
include $_SERVER['DOCUMENT_ROOT'] . '/'.$opac_path.'/components/search_advanced.php';
}
