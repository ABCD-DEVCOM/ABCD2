 ...
 * 
 */
include($_SERVER['DOCUMENT_ROOT'] . "/".$opac_path."/presentar_registros.php");
...
<form name="bi" action="/<?php echo $opac_path;?>/buscar_integrada.php" method="post">
...
function BuscarIntegrada(base, modo, Opcion, Expresion, Coleccion, titulo_c, resaltar, submenu, Pft, mostrar_exp) {
    ...
    if (mostrar_exp != "") document.bi.action = "/<?php echo $opac_path;?>/inicio_base.php"
