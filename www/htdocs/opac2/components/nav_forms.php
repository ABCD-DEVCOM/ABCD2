            ...
            <nav class="col-md-12 col-lg-12 bg-light d-xl-inline sidebar">
                <div class="position-sticky pt-3">
                    <ul class="nav flex-md-column flex-xl-row">
                        <li class="nav-item">
                            <a class="nav-link <?php if  (($t_action=='free') or ($t_action=='')) echo "active";?>" href="/opac/?action=free">
	...
	?>
                        <li class="nav-item">
                            <a class="nav-link <?php if ($t_action=='advanced') echo "active ";?>" aria-current="page" href="/opac/?action=advanced">
