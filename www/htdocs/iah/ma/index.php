...
?>
	...
	<script language="JavaScript">
		function startIAH(base){
            var aux="/cgi-bin/"+<?php echo $cisis_ver;?>+"wxis/iah/scripts/?IsisScript=iah.xis&lang=en&base="+base;
			this.location=aux;
		}
	</script>
	<style>
  ...
  <BODY BGCOLOR="#eoebeb" link="green" vlink="green">
   	...
   	<div align="right">
		[ <a href="../pt/index.htm">portugu�s</a> | <a href="../es/index.htm">espa�ol</a> | english ]
	</div>
