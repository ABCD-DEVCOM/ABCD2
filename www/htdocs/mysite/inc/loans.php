                            ...
                            <div class="card mb-5 table-responsive">
                                <table class="table table-striped">
                                    ...
                                    <tr>
                                        ...
                                        <button type="button"  class="btn btn-primary" id="renew" OnClick="javascript:LoanRenovation('<?php echo $loan["copyId"] ?>','<?php echo $loan["location"] ?>')" data-bs-toggle="modal" data-bs-target="#abcdModal">
