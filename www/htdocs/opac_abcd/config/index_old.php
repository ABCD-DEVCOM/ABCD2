<?php
session_start();
header('Content-Type: text/html; charset=<?php echo "utf-8"?>');
?>
<script>
		...
		if (substr($value,0,7)=="include" and $config_php==""){
			if ($config_php==""){
				...
				if (!file_exists($config_php)){
					...
					echo "<br><br><a href=javascript:ShowHide(\"help_01\")>See tutorial, item 5</a>";
					?>
					<div id="help_01" style="display:none;margin:auto;width:100%;xheight:150px; position:relative;border:1px solid black;">
...
<div style="xmin-height:400px;float:left; margin-top:40px;">;
...
<input type=hidden name=cipar value=acces.par>
	<table align=center>
		<tr><td colspan=2 align=left><a href=javascript:ShowHide("help_02")><img src=../images_config/helper_bg.png height=20 style="vertical-align:middle"> <font size=2 style="vertical-align:middle"><?php echo $msgstr["show_hide"]." ". $msgstr["help"];?></font></a></td></tr>
		<tr>
...
<div id="help_02" style="clear:both;display:<?php echo $showhide_help;?>;margin:0px;width:100%;xheight:150px; position:relative;border:1px solid black;">
	<iframe style="width:100%; height:500px; border:0" src=http://wiki.abcdonline.info/OPAC-ABCD_Tutorial_de_configuraci%C3%B3n#Entrada_al_m.C3.B3dulo_de_configuraci.C3.B3n>
