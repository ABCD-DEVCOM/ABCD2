...
INDEX TW=^1defecto^2defecto^3default^4défaut^d*^xTW ^uTW_^yDATABASE^mTW_
INDEX Au=^1Autor^2Autor^3Author^4Auteur^xAU ^uAU_^yDATABASE^mAU_
INDEX De=^1descriptor^2descriptor^3descriptor^4déscripteur^xDE ^uDE_^yDATABASE^mDE_
...
FORMAT standard.pft=^1defecto^2pformat padrão^3default^4Defaut
