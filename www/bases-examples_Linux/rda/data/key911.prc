...
s(if p(v130^a) then v130^a,|.|v130^m,|.|v130^n,|.|v130^r,|.|v130^f,|.|v130^g,|.|v130^p,|.|v130^k,|.|v130^o 
...
else v245^a,|.|v245^b,|.|v245^n,|.|v245^p ,if p(v100^a) then |.|v100^a else |.|v110^a fi fi fi fi) 
,'.',''),',',''),'/',''),':',''),' ',''), 
'</911>',
